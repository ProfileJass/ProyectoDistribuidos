...
Nginx distribuye las peticiones usando el algoritmo `least_conn`:
- Envía la petición al servidor con menos conexiones activas
- Mejora el rendimiento bajo carga alta
...
docker inspect shared-postgres-db
```
...
- Los healthchecks verifican cada 30 segundos
- Tiempo de timeout: 10 segundos
- Reintentos: 3 antes de marcar como unhealthy
- Los datos persisten en el volumen `postgres-data`
